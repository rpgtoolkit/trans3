 ...
 */
void coords::tileToPixel(int &x, int &y, const COORD_TYPE coord, const bool bAddBasePoint, 
						 const int brdSizeX)
{
 ...
 */
void coords::pixelToTile(int &x, int &y, const COORD_TYPE coord, const bool bRemoveBasePoint, 
						 const int brdSizeX)
{
	if (bRemoveBasePoint)
	{
 ...
 */
void coords::isometricTransform(double &x, double &y, const COORD_TYPE oldType, 
								const COORD_TYPE newType, const int brdSizeX)
{
